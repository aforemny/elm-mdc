...
import Internal.Tabs.Model exposing (Model, defaultModel, Msg(..), Geometry, defaultGeometry)
    ...
    case msg of
        ...
        ScrollBack geometry ->
            let
                ...
                scrollTargetIndex =
                    Maybe.withDefault 0 << .scrollTargetIndex <|
                    List.foldl loop
...
tabs lift model options nodes =
    let
        ...
        tabBarScroller tabBar =
            ...
            , styled Html.div
              ...
              , Options.attribute << Html.property "scrollLeft" <|
    ...
    in
        ...
        Options.apply summary
            ...
            ( List.concat
              [ nodes
                |> List.indexedMap (\index { options, childs }  ->
                       let
                          ripple =
