...
{-| From the [Material Design Lite documentation](https://github.com/google/material-design-lite/tree/mdc-1.x/src/typography#introduction):
...
{- The material specification requires many typographic elements to have
   ...
   (e.g., `mdc-typography--display-1`) and one with reduced contrast adhering to
   the spec when drawn black on white (e.g.,
   `mdc-typography--display-1-color-contrast`). The latter are implemented
...
display1 =
    cs "mdc-typography--display-1-color-contrast"
...
display2 =
    cs "mdc-typography--display-2-color-contrast"
...
display3 =
    cs "mdc-typography--display-3-color-contrast"
...
display4 =
    cs "mdc-typography--display-4-color-contrast"
...
headline =
    cs "mdc-typography--headline-color-contrast"
...
title =
    cs "mdc-typography--title-color-contrast"
...
subhead =
    cs "mdc-typography--subhead-color-contrast"
...
body1 =
    cs "mdc-typography--body-1-force-preferred-font-color-contrast"
...
body2 =
    cs "mdc-typography--body-2-force-preferred-font-color-contrast"
...
caption =
    cs "mdc-typography--caption-force-preferred-font-color-contrast"
...
button =
    cs "mdc-typography--button-color-contrast"
...
menu =
    cs "mdc-typography--menu-color-contrast"
...
tableStriped =
    cs "mdc-typography--table-striped"
...
justify =
    cs "mdc-typography--text-justify"
...
capitalize =
    cs "mdc-typography--text-capitalize"
...
lowercase =
    cs "mdc-typography--text-lowercase"
...
uppercase =
    cs "mdc-typography--text-uppercase"
