...
For a long-form tutorial, @jadams kindly wrote up a very nice [introduction to using elm-mdl](https://medium.com/@dailydrip/introduction-to-using-material-design-in-elm-dc2320087410#.dodoot1wd).
