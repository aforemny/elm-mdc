...
view model  =
  ...
  , div []
    [ Footer.mega []
        [ Footer.top []
            [ Footer.left []
                [ Footer.socialButton [Footer.onClick FooterMsg, Options.css "margin-right" "6px"] []
                , Footer.socialButton [Options.css "margin-right" "6px"] []
                , Footer.socialButton [] []
                ]
            , Footer.right []
                [ Footer.wrap <|
                    Footer.link [Footer.href "#"] [text "Introduction"]
                , Footer.wrap <|
                    Footer.link [Footer.href "#"] [text "App Status Dashboard"]
                , Footer.wrap <|
                    Footer.link [Footer.href "#"] [text "Terms of Service"]
                ]
            ]
        , Footer.middle []
            [ Footer.dropdown []
                [ Footer.heading []
                    [Footer.text "Mega Footer Example"]
                , Footer.links []
                    <| createLinks 6
                ]
            ]
  ...
  --          [Footer.logoTest [] [text "banana"]
  --          ]
  --       ]
  --   ]
  -- , div [Attrs.style [("margin-top", "60px")]] []
  -- , div []
  --   [ Footer.footer Footer.Mega []
  --       [Footer.topTest []
  --          [Footer.leftTest []
  --               [ Footer.wrap <| button [Attrs.class "mdl-mega-footer__social-btn"] []
  --               , Footer.wrap <| button [Attrs.class "mdl-mega-footer__social-btn"] []
  --               , Footer.wrap <| button [Attrs.class "mdl-mega-footer__social-btn"] []
  --               ]
  --          ,Footer.rightTest []
  --            [ Footer.wrap <| Footer.link [ Footer.href "#" ] [text "Link 1"]
  ...
  --               , Footer.link [ Footer.href "#"] [text "Link 4"]
  --               , Footer.link [ Footer.href "#"] [text "Link 4"]
  --               ]
