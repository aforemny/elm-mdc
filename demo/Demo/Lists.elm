          ...
          [
            ...
            [
              Toggles.radio Mdl [0] model.mdl
                [ Toggles.value False, Options.css "display" "inline"
                ]
                [ ]              
            ]
          ]
        ...
        Lists.li [Lists.threeLine]
          [
            ...
            [
                Options.styled Html.i [Lists.itemAvatar][Icon.view "person" [Icon.size36]]
              , Options.span [][text "Bryan Cranston"]
              , Options.span [ Lists.itemTextBody][text "Bryan Cranston played the role of Walter in Breaking Bad. He is also known
      ...
      , Lists.li [Lists.threeLine]
          [
            ...
            [
              Options.styled Html.i [Lists.itemAvatar][Icon.view "person" [Icon.size36]]
              , Options.span [][text "Aaron Paul"] 
              , Options.span [ Lists.itemTextBody][text "Aaron Paul played the role of Jesse in Breaking Bad. He also featured in
      ...
      , Lists.li [Lists.threeLine]
          [
            ...
            [
              Options.styled Html.i [Lists.itemAvatar][Icon.view "person" [Icon.size36]]
              , Options.span [][text "Bob Odenkirk"] 
              , Options.span [ Lists.itemTextBody][text "Bob Odinkrik played the role of Saul in Breaking Bad. Due to public fondness for the
