    ...
    styled Html.div
        ...
        , styled Html.nav
            ...
            [ Lists.ul
                ...
                ([ { url = Button
                   , icon = "ic_button_24px.svg"
                   , title = "Button"
                   , subtitle = "Raised and flat buttons"
                   }
                 , { url = Card
                   , icon = "ic_card_24px.svg"
                   , title = "Card"
                   , subtitle = "Various card layout styles"
                   }
                 , { url = Checkbox
                   , icon = "ic_selection_control_24px.svg"
                   , title = "Checkbox"
                   , subtitle = "Multi-selection controls"
                   }
                 , { url = Chips
                   , icon = "ic_component_24px.svg"
                   , title = "Chips"
                   , subtitle = "Chips"
                   }
                 , { url = Dialog
                   , icon = "ic_dialog_24px.svg"
                   , title = "Dialog"
                   , subtitle = "Secondary text"
                   }
                 , { url = Drawer
                   , icon = "ic_side_navigation_24px.svg"
                   , title = "Drawer"
                   , subtitle = "Various drawer styles"
                   }
                 , { url = Elevation
                   , icon = "ic_shadow_24px.svg"
                   , title = "Elevation"
                 ...
                 , { url = List
                   , icon = "ic_list_24px.svg"
                   , title = "List"
                   , subtitle = "Item layouts in lists"
                   }
                 , { url = Menu
                   , icon = "ic_menu_24px.svg"
                   , title = "Menu"
                   , subtitle = "Pop over menus"
                   }
                 , { url = RadioButton
                   , icon = "ic_radio_button_24px.svg"
                   , title = "Radio buttons"
                   , subtitle = "Single selection controls"
                   }
                 , { url = Ripple
                   , icon = "ic_ripple_24px.svg"
                   , title = "Ripple"
